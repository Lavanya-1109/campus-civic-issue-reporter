...
\end{itemize}
Supporting and Infrastructure: Cloudinary or AWS S3 for image attachments,
...
\textbf{Material resources:} GitHub for version control and CI (GitHub
...
\textbf{Budget:} No external funding required; all resources are
...
This project proposes a civic issue reporter, a role-based web platform
