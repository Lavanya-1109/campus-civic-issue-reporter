document.addEventListener('DOMContentLoaded', async () => {
  ...
  try {
    ...
    mount.innerHTML = '<div class="text-center py-24"><p class="text-body-sm font-body-sm text-error mb-2">Couldn\'t load reports right now.</p><a class="text-label-md font-label-md text-secondary hover:underline" href="../reports/reports.html">Open Reports directly →</a></div>';
  }
});
